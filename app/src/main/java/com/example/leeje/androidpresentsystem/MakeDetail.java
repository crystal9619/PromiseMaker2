...
//        currentMarker = mGoogleMap.addMarker(markerOptions);
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        departure=latLng;
        databaseReference.child("박수정").child("start").child("lat").setValue(departure.latitude);
        databaseReference.child("박수정").child("start").child("lon").setValue(departure.longitude);
