    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseRef.child("박수정").child("ck1").child("lat").setValue(ck1lat);
                databaseRef.child("박수정").child("ck1").child("lon").setValue(ck1lon);
                databaseRef.child("박수정").child("ck2").child("lat").setValue(ck2lat);
                databaseRef.child("박수정").child("ck2").child("lon").setValue(ck2lon);
    ...
    public void readData(final GoogleMap googleMap)
    {
        databaseRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                lat=dataSnapshot.child("박수정").child("start").child("lat").getValue(Double.class);
                lon=dataSnapshot.child("박수정").child("start").child("lon").getValue(Double.class);
